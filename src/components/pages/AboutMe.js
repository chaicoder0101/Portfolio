...
<div class="card">
  ...
  <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
    <div class="card-body">
    <li>B.Tech in Computer Science Engineering.</li><li>Msc in International Software System Science.</li>
    </div>
  </div>
</div>
<div class="card">
  ...
  <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
    <div class="card-body">
    <li>Selected to attend in "GOING BEYOND" live interaction with Astronaut Sunita Williams organized by Atlantis Research in
         collaboration with American center, New Delhi.</li>
...
<div class="card">
  ...
  <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
    <div class="card-body">
    <li>Excellent management skills.</li><li>Good programming skills.</li>
     <li>Fast learner</li><li>Motivated spirit</li><li>Focused attitude</li><li>Extremely good work ethic.</li>
    </div>
  </div>
</div>
</div>
